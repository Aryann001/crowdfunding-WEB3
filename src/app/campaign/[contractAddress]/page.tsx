...
export default function CampaignPage() {
    ...
    const { contractAddress: campaignAddress } = useParams();
    ...
    const totalBalance = !balance ? "0" : balance?.toString();
    ...
    return (
        <div className="mx-auto max-w-7xl px-2 mt-4 sm:px-6 lg:px-8">
            <div className="flex flex-row justify-between items-center">
                {!isLoadingName && (
                    <p className="text-4xl text-purple-600 font-semibold">{name}</p>
                )}
            ...
            {!isLoadingBalance && (
                <div className="mb-4">
                    ...
                    <div className="relative w-full h-6 bg-gray-200 rounded-full dark:bg-gray-700">
                        <div className="h-6 bg-purple-600 rounded-full dark:bg-purple-500 text-right" style={{ width: `${balancePercentage?.toString()}%`}}>
            ...
            <div>
                ...
                <div className="grid md:grid-cols-3 grid-cols-1 gap-4">
                    ...
                    {isEditing && (
                        ...
                        <button
                            className="max-w-sm flex flex-col text-center justify-center items-center font-semibold p-6 bg-purple-500 text-white border border-slate-100 rounded-lg shadow"
